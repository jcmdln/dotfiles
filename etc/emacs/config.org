...
*** eww-lnum
This package allows pressing "f" or "F" to follow links using their
numerical reference, much like other text-based browsers.
...
(use-package go-mode
  ;; go get -u -v https://github.com/stamblerre/gocode
  :init
